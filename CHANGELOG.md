...
- Default layout support for loadouts that should share one layout.
- Basic slash commands: open options (`/als`), list mappings (`/als list`), toggle debug, test API info dump.
